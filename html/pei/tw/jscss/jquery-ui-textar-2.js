    ...
    */
    ...
    function Datepicker() {
        ...
        this.regional[""] = { // Default regional settings
            ...
            firstDay: 0, // 第一天是週日。 The first day of the week, Sun = 0, Mon = 1, ...
        ...
        this._defaults = { // Global defaults for all the date picker instances
            ...
            /*********** Kuo-Liang Chang ***********/
            buttonText: "選擇", // Text for trigger button
            changeMonth: true, // True if month can be selected directly, false if only prev/next
            changeYear: true, // True if year can be selected directly, false if only prev/next
            yearRange: "-108:+1", // Range of years to display in drop-down,
            ...
            showButtonPanel: true, // 顯示下方的按鈕區 True to show button panel, false to not show it
            onSelect: function() { this.fireEvent && this.fireEvent('onchange') || $(this).change(); }, // Define a callback function when a date is selected
            /*********** Kuo-Liang Chang ***********/
        ...
        this.dpDiv = datepicker_bindHover($("<div id='" + this._mainDivId + "' class='x-datepicker ui-widget ui-widget-content ui-helper-clearfix ui-corner-all'></div>"));
    }
    ...
    $.extend(Datepicker.prototype, {
        ...
        */
        ...
        _newInst: function (target, inline) {
			...
			datepicker_bindHover($("<div class='" + this._inlineClass + " x-datepicker ui-widget ui-widget-content ui-helper-clearfix ui-corner-all'></div>")))
            };
        },
        ...
        */
        ...
        _generateHTML: function (inst) {
            ...
            "<a class='x-datepicker-prev' data-handler='prev' data-event='click'" + " title='" + prevText + "'>" +
            "<button type='button'>◀" + prevText + "</button>" +
            "</a>" :
			...
			"<a class='x-datepicker-next' data-handler='next' data-event='click' title='" + nextText + "'>" +
            "<button type='button'>" + nextText + "►</button>" +
            "</a>" :
                ...
                for (col = 0; col < numMonths[1]; col++) {
                    ...
                    for (dRow = 0; dRow < numRows; dRow++) { // create date picker rows
                        ...
                        for (dow = 0; dow < 7; dow++) { // create date picker days
							...
							(unselectable ? "<span class='ui-state-default'>" + printDate.getDate() + "</span>" : "<a class='ui-state-default week-" + ((dow + firstDay + 6) % 7) +
        ...
        _generateMonthYearHeader: function (inst, drawMonth, drawYear, minDate, maxDate,
            ...
            if (!inst.yearshtml) {
                ...
                if (secondary || !changeYear) {
                    ...
                    /* Kuo-Liang Chang 改變順序，近的在上 https://stackoverflow.com/a/8070396/7849463 */
                    //for (; year <= endYear; year++) {
                    var minYear = year; year = endYear;
                    for (; year >= minYear; year--) {
                        inst.yearshtml += "<option value='" + year + "'" +
						(year === drawYear ? " selected='selected'" : "") +
						">" + year + "(" + (year - 1911) + ")年</option>";
                    }
            ...
            // html += this._get(inst, "yearSuffix"); // 年
            html += "&nbsp";
            if (showMonthAfterYear) {
